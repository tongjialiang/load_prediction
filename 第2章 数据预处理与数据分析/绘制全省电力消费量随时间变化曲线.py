...
###########################################################
frompath="C:\\myfiles\\毕业论文\\论文撰写\\实验结果与配图\\第8章基于改进Transformer模型的负荷预测方法\\宏观经济数据-电力弹性系数.xls"
topath="C:\\myfiles\\毕业论文\\论文撰写\\实验结果与配图\\第8章基于改进Transformer模型的负荷预测方法\\全省电力消费量随时间变化曲线.jpg"
...
x=data["宏观经济数据-电力弹性系数"]["年份"]########
y=data["宏观经济数据-电力弹性系数"]["全省电力消费量(百亿度)"]########
...
sns.lineplot(x,y,label="全省电力消费量(百亿度)")
plt.legend()
