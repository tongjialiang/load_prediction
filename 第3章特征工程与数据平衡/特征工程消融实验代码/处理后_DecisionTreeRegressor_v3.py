...
# 设置model-name，记录日志用
model_name = 'DecisionTreeRegressor_v3'
# 执行小批量数据集 百分比
use_data = False
use_data_ratio = 1
min_use_data = 2000
...
class model_DecisionTreeRegressor_v3:###################################################################################################要修改
    ...
    def do_model(self):
        ...
        # f.close()
        # with open('D:\\myfiles\\毕业论文\\论文撰写\\实验结果与配图\\第8章基于改进Transformer模型的负荷预测方法\\绘制预测曲线与损失曲线\\'+'_'+self.how_long+'_DecisionTreeRegressor预测值.pk', 'wb+') as f:
