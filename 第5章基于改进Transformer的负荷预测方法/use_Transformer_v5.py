...
'''
#设置数据可视化日志存储目录
view_dir="D:\\实验记录\\实验结果\\Transformer_v5\\log\\"

# 设置模型
# model = KNeighborsRegressor()

# 设置model-name，记录日志用
model_name = 'Transformer_v5'
...
res_ajustParameter_data=[batch_size,num_epochs,lr,num_epoch_quiet,myopt,feature_size,num_layers,nhead,seed]
# dir='D:\\数据采样完成\\按行业划分数据集_方案1-汇总标准化_住宿和餐饮业_MT_data_4_1.pk'
class use_Transformer_v5():###################################################################################################要修改
