...
###########################################################
frompath="C:\\myfiles\\毕业论文\\论文撰写\\实验结果与配图\\第6章电力数据质量分析与异常监控系统\\数据倾斜的识别与处理.xls"
topath="C:\\myfiles\\毕业论文\\论文撰写\\实验结果与配图\\第6章电力数据质量分析与异常监控系统\\平衡协调算法处理前的类间数据分布.jpg"
data=read_excel(frompath)
print("打印有多少列")
print(data["处理前"].columns)########
...
plt.rc('font',size=8)
plt.pie(x,labels=kinds,autopct="%1.2f%%",startangle=60)
