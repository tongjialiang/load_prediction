...
###########################################################
frompath="C:\\myfiles\\毕业论文\\论文撰写\\实验结果与配图\\第三章数据集划分方式的研究\\聚类kmeans调参max_iter结果.xls"
topath="C:\\myfiles\\毕业论文\\论文撰写\\实验结果与配图\\第三章数据集划分方式的研究\\聚类kmeans调参max_iter结果.jpg"
data=read_excel(frompath)
print("打印有多少列")
print(data["聚类kmeans调参max_iter结果"].columns)########
